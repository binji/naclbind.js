...
bool GetHandleFloat(Handle handle, float* out_value) {
  ...
  switch (hobj.type) {
    ...
    TYPE_CASE_TRUNC_INT_TO_FLOAT(TYPE_FLOAT, TYPE_ULONG);
...
bool GetHandleDouble(Handle handle, double* out_value) {
  ...
  switch (hobj.type) {
    ...
    TYPE_CASE(TYPE_DOUBLE, TYPE_ULONG);
